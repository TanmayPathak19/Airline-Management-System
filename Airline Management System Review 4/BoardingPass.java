...
public class BoardingPass extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        // Data Validation: Ensure that the PNR field is not empty
        if (pnr.isEmpty()) {
        ...
        try {
            ...
            // Innovative Feature: Fetch data from the database for dynamic updates
            ...
            if (rs.next()) {
                ...
                // Data Validation: Handle invalid PNR gracefully
                JOptionPane.showMessageDialog(null, "Please enter correct PNR");                
            }
        } catch (Exception e) {
            // Code Quality: Log and handle exceptions effectively
            e.printStackTrace();
        }
    }
